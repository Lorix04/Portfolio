...
3. **Lista delle Attività**: Dopo aver inserito i dettagli, le attività verranno mostrate nella lista con le seguenti informazioni:
   - Nome: Il nome dell'attività.
   - Creato: La data e ora di creazione dell'attività. 
      *(Formato: [Giorno][Mese][Anno] [Ore][Minuti][Secondi] )*
...
4. **Attività Completata**: Cliccando su un'attività, l'utente può marcarla come completata.
5. **Visualizza Attività Completate**: Una sezione che mostra le attività completate.
